...
public class UserMapperTest extends AbstractDynamoTests<User> {
    ...
    protected User model(String id) {
        User model = User.builder().id(id).name(id + ", funny").joinDate().build();
        return model;
    }
    ...
    public void ut1005_batchSave() throws Exception {
        try {
            User u1 = User.builder().joinDate().name("aider").numberOfPlaylists(1)
                    .postCode("1221").testSet("1", "2").build();
            User u2 = User.builder().joinDate().name("lamp").numberOfPlaylists(1)
                    .postCode("1221").testSet("1").build();
            User u3 = User.builder().joinDate().name("pinegreen").numberOfPlaylists(1)
                    .postCode("1222").testSet("1", "2", "3").build();
            User u4 = User.builder().joinDate().name("john").numberOfPlaylists(1)
                    .postCode("1222").testSet("1").build();
            User u5 = User.builder().joinDate().name("peter").numberOfPlaylists(1)
                    .postCode("1222").testSet("1", "2", "3").build();
            User u6 = User.builder().joinDate().name("carl").numberOfPlaylists(1)
